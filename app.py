...
def card_start(label=None):
    st.markdown(f'<div class="card">{f"<div class=card-label>{label}</div>" if label else ""}',
                unsafe_allow_html=True)
